...
<body>
	...
	<div class="breadcrumb-wrapper">
		<div class="container">
			<div class="row">
				<div class="isi-aktivasi">
					<h2 class="title">Aktivasi Membership zenius.net</h2>
				</div>
	...
	<div class="content">
		<div class="container">
				...
				if (!isset($_SESSION['email'])) {
					  ?>
					  <div id="vguest-messages" class="alert alert-warning">
					  	<p>Silakan&nbsp;<a id="vguest-sign-in" href="login.php">sign-in</a>&nbsp;terlebih dahulu</p>
					  </div>
					  <?php
				}else{
			...
			<form id="vactivate" class="form-horizontal" method="post" action="backend/aktivasivc.php">
					<div class="form-group"><label class="col-lg-2 col-xs-5 control-label" for="inputEmail3">Kode aktivasi membership</label>
						<div class="col-lg-4 col-xs-7">
							...
							if (!isset($_SESSION['email'])) {
								?>
								<input id="vcode" class="form-control" disabled="disabled" name="vcode" required="" type="text" />
								<?php
							}else{
								?>
								<input id="vcode" class="form-control" name="vcode" required="" type="text" />
								<?php
							} 
							 ?>
			...
			<div class="row">
				<div class="col-xs-12 pb5">
					<div>Belum punya membership zenius.net? Beli&nbsp;<a href="#">di sini</a>!</div>
						<p>&nbsp;</p>
						<h3>Aktivasi membership Xpedia 2.0</h3>
						<p>&nbsp;</p>
					<div>Untuk aktivasi membership Xpedia 2.0 klik&nbsp;<a href="#">di sini</a>!</div>
					<div>Mau tau tentang Xpedia 2.0? Klik&nbsp;<a href="#">di sini</a>!</div>
				</div>
			</div>
		</div>
	</div>
