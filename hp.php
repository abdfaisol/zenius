...
if (!isset($_SESSION['email'])) {
    ...
    <!-- Akhir dari menu -->
        <div class="container d-flex justify-content-xl-center align-items-xl-center" style="margin-top: 25px;margin-bottom: 35px">
    ...
    <div class="footer">
        ...
        <script src="assets/bootstrap/js/bootstrap.min.js"></script><script src="menu.js"></script>
    </body>
    </html>