...
$email=$_POST["email"];
$pass=$_POST["pass"];
$res=mysqli_query($db,"SELECT * FROM member WHERE email = '$email' AND password = '$pass' ;");
		...
		<div class="ContainerPost full-w flex relative">
			<div id="direct-sukses" class="Sign container centerMargin flex directionFlexRow">
				<div class="container">
					...
					<p style="font-size: 14px;margin: 1rem 0;">Silahkan klik&nbsp;<a class="returnlink" href="$" style="font-weight: 500">link berikut ini</a></p>
				</div>
			</div>
		</div>
		</div>
