...
<html>
<head>
	<title>Membership - Zenius Education</title>
...
<body>
	...
	<div class="post full-w">
		<div class="ContainerPost full-w flex relative">
			<div class="membership wrapperSizeDefault centerMargin">
				<div class="iklan">
					<img src="img/iklan.png">
				</div>
				<div class="judul textcenter wrapperSizeDefault centerMargin paddingSpaceMedium">
					<h1>Jangan tunda persiapan belajar kamu.</h1>
					<h1>Mulai lebih cepat, lebih baik!</h1>
				</div>
				<div class="membership full-w flex justifyBetween spaceTopDown">
					<div class="boxMembership smallHeight flex">
						<div class="titleMembership flex flexCenterAll textcenter">
							<p>Membership <br><span>1 Bulan</span></p>
						</div>
						<div class="price flex flexCenterAll">
							<h1>Rp 313.500</h1>
						</div>
					</div>
					<div class="boxMembership smallHeight flex">
						<div class="titleMembership flex flexCenterAll textcenter">
							<p>Membership <br><span>6 Bulan</span></p>
						</div>
						<div class="price flex flexCenterAll">
							<h1>Rp 785.000</h1>
						</div>
					...
					<div class="boxMembership smallHeight flex">
						<div class="titleMembership flex flexCenterAll textcenter">
							<p>Membership <br><span>9 Bulan</span></p>
						</div>
						<div class="price flex flexCenterAll">
							<h1>Rp 970.000</h1>
						</div>
					...
					<div class="boxMembership smallHeight flex">
						<div class="titleMembership flex flexCenterAll textcenter">
							<p>Membership <br><span>12 Bulan</span></p>
						</div>
						<div class="price flex flexCenterAll">
							<h1>Rp 1.185.000</h1>
						</div>
					...
					<div class="boxMembership smallHeight flex">
						<div class="titleMembership flex flexCenterAll textcenter">
							<p>Membership <br><span>24 Bulan</span></p>
						</div>
						<div class="price flex flexCenterAll">
							<h1>Rp 1.850.000</h1>
						</div>	
				...
				<div class="full-w flex flexAlignCenter paddingSpaceLarge">
					<button class ="button centerMargin" style="color: black;  padding: 15px 100px; font-size: 16px;">
						Mulai Belajar
					</button>
				</div>
		...
		<div class="ContainerPost full-w flex relative" style="background-color:#eaeaea;">
			<div class="wrapperSizeDefault centerMargin" style="padding: 75px 0">
				<h1 class="textcenter h1Origin">
					Dengan menjadi member, <br>
					kamu akan mendapatkan :
				</h1>
				<div class="flex full-w justifyBetween">
					<div class="list mb4 flex directionFlexColoum">
						<div class="titleMembership flex flexCenterAll textcenter bg3636">
							<p>Video Pembelajaran</p>
						</div>
						<div class="contentList">
							<p>
								Akses ke lebih dari 66.000 video materi pelajaran dari SD hingga SMA termasuk persiapan masuk universitas.
							</p>
						</div>
					</div>
					<div class="list mb4">
						<div class="titleMembership flex flexCenterAll textcenter bg3636">
							<p>Latihan soal PDF</p>
						</div>
						<div class="contentList">
							<p>
								Lebih dari 3.400 paket latihan soal yang bisa kamu download untuk melatih kemampuan kamu.
							</p>
						</div>
					</div>
					<div class="list mb4">
						...
						<div class="contentList">
							<p>
								Semua ribuan paket latihan soal yang tersedia telah dilengkapi dengan video pembahasan soal.
							</p>
						</div>
					</div>
					<div class="list mb4">
						...
						<div class="contentList">
							<p>
								Kamu bisa belajar di manapun dan kapanpun selama kamu terhubung dengan internet.
							</p>
						</div>
					</div>
				</div>
		...
		<div class="matkul full-w flex flexAlignCenter">
			...
			<div class="menu-matkul">
				<ul class="matkulMenu titleMatkul" id="matakul">
					<li class="active2" id="mat"><a href="">MATEMATIKA</a></li>
					<li id="ipa"><a href="">IPA</a></li>
					<li id="ips"><a href="">IPS</a></li>
					<li id="bhs"><a href="">BAHASA</a></li>
				</ul>
				<div class="kurikulum mn-kul">
					<ul class="matkulMenu" id="scdMatkul">
						<li id="ktsp" class="active2"><a href="">KTSP</a></li>
						<li id="k13"><a href="">KURIKULUM 2013</a></li>
						<li id="k13r"><a href="">KURIKULUM 2013 REVISI</a></li>
					</ul>
				</div>
