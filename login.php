	...
	<div class="post full-w">
		<div class="ContainerPost full-w flex relative">
			<div id="coks" class="Sign container centerMargin flex directionFlexRow">
				...
				<div class="sign-1">
					<form class="needs-validation" novalidate method="post" action="ceklogin.php?return=<?=$_GET['return'] ?>">
						<div class="feed-alert">
							Tulis e-mail dengan format yang benar
						</div>
						<div class="form-group relative">
							<input type="text" class="form-control emailku" name="email" placeholder="Ketik alamat e-mailmu" id="Email" aria-describedby="emailHelp" required>
						</div>
						<div class="feed-alert">
						...
						<p style="padding: 15px 0" align="center" class="pesan">Belum memiliki akun? <a href="">Daftar sekarang</a></p>
					</form>
				</div>
			</div>
		</div>
